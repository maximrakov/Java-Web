...
public class TalkRepositoryImpl implements TalkRepository {
    @Override
    public void addMessage(long id, String message, long from, long to) {
        Statement statement = null;
        try {
            PreparedStatement preparedStatement = DatabaseUtils.getDataSource().prepareStatement("INSERT INTO Talk VALUES(?, ?, ?)");
